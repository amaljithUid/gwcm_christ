...
function twentyseventeen_fonts_url() {
	...
	*/
	$libre_franklin = _x( 'on', 'Roboto+Condensed font: on or off', 'twentyseventeen' );
...
* Adds a `js` class to the root `<html>` element when JavaScript is detected.
	...
	*/
	...
	wp_enqueue_style( 'animateCss', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.2.3/animate.min.css', array(), '3.2.3' );
	...
	wp_enqueue_script( 'jquery-custom', get_theme_file_uri( '/assets/js/custom.js' ), array(), '1.0.0', true );
	/**
